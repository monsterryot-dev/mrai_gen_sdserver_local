...
from app.services.google.imagen import GoogleImagenTextService
...
async def generateImageFromText(
    request: ImagenTextRequestPost = Depends(ImagenTextRequestPost.asForm)
):
    service = GoogleImagenTextService()
